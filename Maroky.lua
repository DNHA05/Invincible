...
repeat wait() until game:IsLoaded()
	...
	_G.Settings = {
		...
		Main = {
			...
			--[Biển 2]
			["Auto Third Sea"] = false, statements 
			["Auto Factory"] = false,
...
function TP2(P1)
    ...
    function Text(value)
		game.StarterGui:SetCore("SendNotification", {
			Title = "Maroky Notification", 
			Text = tostring(value),
			Icon = "http://www.roblox.com/asset/?id=16320117573",
			Duration = 10
		})
	end
...
SOMEXHUBMODILE.Name = "SOMEXHUBMODILE"
        ...
        MODILEMAGE.Image = "http://www.roblox.com/asset/?id=16320117573"
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(16320117573)
...
local LogoToggle = Instance.new("ImageLabel")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(16320117573)
...
Main:Label("Maroky Hub By imharbl")
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Đảo Bí Ẩn 🏝️") then
				mr:Set("Đảo Bí Ẩn 🏝️ : Có Đấy Tìm Đi ✅")
			else
				mr:Set("Đảo Bí Ẩn 🏝️ : Không Có Đâu ❌")
			end
		end)
	end
end) 
